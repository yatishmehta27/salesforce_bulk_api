  ...
  class Job
    ...
    def create_job(batch_size, send_nulls, no_null_list)
      ...
      if response_parsed['exceptionCode']
        raise SalesforceException.new("#{response_parsed['exceptionMessage'][0]} (#{response_parsed['exceptionCode'][0]})")
      end 
    ...
    def get_batch_result(batch_id)
      ...
      # The query op requires us to do another request to get the results  
      if(@operation == 'query') 
